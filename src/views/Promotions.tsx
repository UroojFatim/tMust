...
import promotion1 from "../../public/tMust2.png";
import promotion2 from "../../public/tMust3.png";
import promotion3 from "../../public/tMUST1.png";
      ...
      <section className="h-full mb-32">
        ...
        <div className="flex gap-x-9 gap-y-5 flex-col lg:flex-row">
          ...
          <div className="basis-[45%] lg:basis-[50%] 2xl:basis-[65%] space-y-4">
            <div className="flex-1 bg-brand-sky_light flex flex-col justify-center 2xl:justify-between lg:flex-row items-center text-center lg:text-start gap-9">
          ...
          <div className="basis-[55%] lg:basis-[50%] 2xl:basis-[35%] flex flex-col lg:flex-row justify-center gap-4 ">
            <div className="bg-brand-sky_light flex-1 w-[100%]">
